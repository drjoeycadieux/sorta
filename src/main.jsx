...
function App() {
  ...
  const editReservation = (reservation) => {
    setForm({ ...reservation, rideDate: String(reservation.rideDate).slice(0, 10), rideTime: String(reservation.rideTime).slice(0, 5) })
